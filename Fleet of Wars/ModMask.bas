...
Public Sub Setup(S1 As Long, S2 As Long, dest As Object, pic As Object)
...
BBO = CreateCompatibleBitmap(GetDC(0), dest.ScaleWidth, dest.ScaleHeight)
...
BitBlt BB, 0, 0, dest.ScaleWidth, dest.ScaleHeight, dest.hdc, 0, 0, vbSrcCopy
...
Public Sub BLTIT(ByVal X As Long, ByVal Y As Long, dest As Object)
...
BitBlt dest.hdc, LX, LY, W, H, BB, LX, LY, vbSrcCopy

'blt the alpha values to the screen
SetDIBitsToDevice dest.hdc, X, Y, W, H, 0, 0, 0, H, tmpBits(1), nSRCI, DIB_RGB_COLORS
